    ...
    <script type="text/javascript">
        ...
        if(!isIE && !isEdge && !isIE11) {//兼容chrome和firefox
            ...
            window.onunload = function (){
                ...
                if(_gap_time <= 5){
                    //执行浏览器关闭你所要做的事情比如登出
                    $.post('http://localhost:8083/user/logout2.do?id='+id);
                    //window.location.href="http://localhost:8083/user/logout2.do";
                }else{//浏览器刷新
                }
            }
            window.onbeforeunload = function (){
                ...
                if(is_fireFox){//火狐关闭执行
                    //执行浏览器关闭你所要做的事情比如登出
                    $.get('http://localhost:8083/user/logout.do?id=${sessionScope.user.id}');
    ...
    <div class="row position-relative">
      ...
      <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
        <div class="input-group mb-4 shadow-sm rounded-4 overflow-hidden py-2 bg-white" data-bs-toggle="modal" data-bs-target="#postModal">
          ...
          <input type="text" id="findByName" class="form-control border-0 fw-light ps-1" name="findName" placeholder="查找用户">
          <a href="javascript:findAllByName();" class="text-decoration-none input-group-text bg-white border-0 material-icons text-primary">add_circle</a>
        </div>
        <script>
          function findAllByName() {
            var findName = document.getElementById("findByName");
            <%--  $("#showMyfriendsList").load("${pageContext.request.contextPath}/myFreindsList.jsp");--%>
            <%--window.location.href="http://localhost:8080/findByName.do?findName="+findName.value;--%>
              $.ajax({
                  type:"POST",
                  url:"http://localhost:8080/findByName.do?findName="+findName.value,
                  contentType:"application/json;charset=utf-8",
                  success:function(data){
                      $("#showUserAllList").load("${pageContext.request.contextPath}/showUserALLlist.jsp")
                  }
              })
        ...
        <div class="account-slider" id="showUserAllList">
...
<%--            </c:if>--%>
<%--          </c:forEach>--%>
<<%@include file="showUserALLlist.jsp"%>
          <script type="text/javascript">
            function addfrined(id) {
              console.log(id);
                $.ajax({
                  type:"POST",
                  url:"http://localhost:8080/addFriend.do?id="+id,
                  contentType:"application/json;charset=utf-8",
                  success:function (data) {
                      if (data=="1"){
                        alert("你们已经是好友了！");
        ...
        <div class="p-2 bg-light offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample">
          <div class="sidebar-nav mb-3">
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1">
              <li class="nav-item">
                <a href="#" class="nav-link active"><span class="material-icons me-3">house</span> <span>首页</span></a>
              </li>
              <li class="nav-item">
        ...
        <div class="ps-0 m-none fix-sidebar">
          <div class="sidebar-nav mb-3">
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1">
              ...
              <li class="nav-item">
                <a href="/toSheJiaoPage.do" class="nav-link"><span class="material-icons me-3">account_circle</span> <span>社交</span></a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="javascript:" class="nav-link"><span class="material-icons me-3">logout</span> <span>退出</span></a>
              </li>
<%--              <li class="nav-item dropdown">--%>
<%--                <a class="nav-link dropdown-toggle" href="#" id="offcanvasNavbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">--%>
<%--                  <span class="material-icons me-3">web</span> Pages--%>
