    ...
    <div class="row position-relative">
      ...
      <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
        <div class="d-flex align-items-center justify-content-between mb-1">
          <h6 class="mb-0 fw-bold text-body">好友申请</h6>
        </div>
        <div id="incluePage1" >
          <%@ include file="messageChildPage.jsp"%>
        </div>
      </main>
      <script>
        var shuax = setInterval(shuax,3000);
        function shuax() {
          $.ajax({
            type:"POST",
            url:"http://localhost:8080/messageFindAll.do",
            contentType:"application/json;charset=utf-8",
            success(data){
              $("#incluePage1").load("messageChildPage.jsp");
            }
          })
        }
        ...
        <div class="ps-0 m-none fix-sidebar">
          <div class="sidebar-nav mb-3">
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1">
              ...
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/main.jsp" class="nav-link active" style="position: relative"><span class="material-icons me-3">explore</span> <span>通知</span>
                  </a>
              </li>
